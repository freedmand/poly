...
t.runTests('Interpreter', {
  ...
  arrayMultipleTypes() {
    t.assertEquals(interpretExpression(`[1, '2', 3.0]`),
        `[Int|String|Float](Int(1),String(2),Float(3))`);
  },
  ...
  array2dDifferentTypes() {
    t.assertEquals(interpretExpression(`[[1, 2], ['3', '4']]`),
        '[[Int]|[String]]' +
        '([Int](Int(1),Int(2)),[String](String(3),String(4)))');
  },

  array2dSameDifferentTypes() {
    t.assertEquals(interpretExpression(`[[1, '2'], ['3', 4]]`),
        '[[Int|String]]' +
        '([Int|String](Int(1),String(2)),[String|Int](String(3),Int(4)))');
  },
  ...
  assignSimpleFraction() {
    t.assertEquals(interpret(`a := 2 / 3`), `{
  a = Fraction(2/3)
}`);
  },
