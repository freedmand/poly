    ...
    t.assertEquals(interpret(`a := 2
{
  ...
  reassignConflictingTypesSimple() {
    // Cannot reassign a variable as one type to another without casting.
    t.assertRaises(() => interpret(`a := 3
a = 2.4`));
    t.assertRaises(() => interpret(`a := 3
a = '3'`));
    t.assertRaises(() => interpret(`a := 2.4
a = 3`));
    t.assertRaises(() => interpret(`a := 2.4
a = '3'`));
    t.assertRaises(() => interpret(`a := '3'
