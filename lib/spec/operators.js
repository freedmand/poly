...
export class PolyOpTable extends OperatorTable {
  ...
  initializeOperators() {
    ...
    // Groupings.
    // If no commas are encountered, parentheses acts as a Group, not
    // TupleLiteral.
    this.makeBraceOperator(
        {text: '('}, {text: ')'}, ast.TupleLiteral, false, ast.Group);
    this.makeBraceOperator({text: '['}, {text: ']'}, ast.ArrayLiteral);
