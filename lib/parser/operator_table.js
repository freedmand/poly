...
export class OperatorTable {
   ...
   * @param {!tokenObj=} newlineMatcher The token matcher object that
   *     corresponds to newline tokens, which are used by the parser to delimit
   *     statements.
   * @param {!tokenObj=} generalAssignMatcher The token matcher object that
   *     corresponds to assign and reassign tokens.
   * @param {!tokenObj=} reassignMatcher The token matcher object that
   *     corresponds to just reassign tokens.
   */
  constructor(statementsAst = StatementsAst, emptyAst = EmptyAst,
        newlineMatcher = {type: 'newline'},
        generalAssignMatcher = {type: 'assign'},
        reassignMatcher = {text: '='}) {
    /** @type {!Ast} */
