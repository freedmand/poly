...
export class OperatorTable {
   ...
   *     statements.
   * @param {!tokenObj=} assignMatcher The token matcher object that corresponds
   *     to assign tokens.
   */
  constructor(statementsAst = StatementsAst, emptyAst = EmptyAst,
        newlineMatcher = {type: 'newline'}, assignMatcher = {type: 'assign'}) {
    /** @type {!Ast} */
    ...
    /**
     * The token matcher object that indicates assignments.
     * @type {!TokenMatcher}
     */
    this.assignMatcher = new TokenMatcher(assignMatcher);
