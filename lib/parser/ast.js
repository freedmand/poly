...
export class Ast {
  ...
  constructor(...params) {
    ...
    // Type information.
    /**
     * Whether the Ast operator represents an array type.
     * @type {boolean}
     */
    this.array = false;
    /**
     * Whether the Ast operator represents a tuple type.
     * @type {boolean}
     */
    this.tuple = false;
    /**
     * Whether the Ast operator represents an `or` type.
     * @type {boolean}
     */
    this.or = false;
    /**
     * Whether the Ast operator is an empty operator, e.g. corresponding to the
     * space between a comma and a trailing square bracket.
     * @type {boolean}
     */
    this.empty = false;
  }
...
/**
 * An extension of Ast for empty nodes, like the space between a trailing comma
 * and a closing brace.
 */
