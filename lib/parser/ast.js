...
export class Ast {
  ...
  constructor(...params) {
    ...
    this.variable = false;
    /**
     * Whether the Ast operator is an array literal.
     */
    this.array = false;
    /**
...
/**
 * An extension of Ast for arrays.
 */
export class ArrayAst extends LiteralAst {
  constructor(...params) {
    super(...params);
    this.array = true;
  }
...
/**
 * An extension of Ast for assignments, such as a simple variable assignment.
 */
...
/**
 * An extension of Ast for reassignments, such as a variable set operator.
 */
export class ReassignAst extends AssignAst {
  constructor(...params) {
    super(...params);
    this.reassign = true;
  }
