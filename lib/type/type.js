...
export class ValueTypeOps {
  ...
  constructor(baseType) {
    ...
    /**
     * Stores a mapping of ast name to a function that produces a value type of
     * this.baseType.
...
export class TypeTable {
  ...
  register(typeOps) {
    ...
    typeOps.opTable.forEach(({fn}, op) => {
      this.ops.set(op, {fn, baseType});
    });
  }
}