...
import {Type, OrType, AndType, AlgebraicType} from './type.js';
...
t.runTests('Type', {
  ...
  algebraicTypeUnset() {
    const a = new AlgebraicType(`A'`);
    const int = new Type('Int');
    t.assertTrue(a.match(int));
  },
  ...
  algebraicTypeSet() {
    ...
    const string = new Type('String');
    a.set(string);
    t.assertFalse(a.match(int));
    t.assertTrue(a.match(string));
  },

  algebraicTypeSetAndUnset() {
    const a = new AlgebraicType(`A'`);
    const int = new Type('Int');
    const string = new Type('String');
    a.set(string);
  ...
  algebraicArrayType() {
    const intArray = Type.array(new Type('Int'));
    const aPrimeArray = Type.array(new AlgebraicType('A'));
    t.assertFalse(intArray.match(aPrimeArray));
    t.assertTrue(aPrimeArray.match(intArray));
  },
  ...
  //   // Modify the internal aPrime type to be Int.
  //   aPrimeArray.match(intArray);
  //   const expectedIntArray = Type.array(aPrime);
  //   t.assertEquals(expectedIntArray.specification, '[Int]');
  // },
});
